...
{
    protected static ?string $navigationLabel = 'الشركات المصنعة';
    protected static ?string $modelLabel = 'شركة مصنعة';
    protected static ?string $pluralModelLabel = 'الشركات المصنعة';
